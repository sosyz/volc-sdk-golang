...
const (
	Ak = "AKLTNjI1ZWFiNTg0YjU4NGI4OWFjMjgyYjYwZGQwOTYyMTU" // write your access key
	Sk = "WkdRNVltSTFNVGs1WW1ZMU5HWTBNbUZtWTJFNVlURmtNRFptTnpBMFpqTQ==" // write your secret key
)
