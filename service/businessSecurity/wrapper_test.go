...
const (
	Ak = "AKLTNGI4OWZjYTBkZjZjNGE4OGExNDE2YzliYWI4MDRmMmI"              // write your access key
	Sk = "WmpjM1ptRmlOMlUxWmpReU5HWTBNMkUyTkdFMk9UVXdOakkwWXpSaU1XRQ==" // write your secret key
)
